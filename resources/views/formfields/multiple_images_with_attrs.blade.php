            ...
            @foreach($images as $image)
                <div class="img_settings_container" data-field-name="{{ $row->field }}">
                    ...
                    <div class="form-group">
                        <input class="form-control" placeholder="Alt" type="text" name="{{ $row->field }}_ext[{{ $loop->index }}][alt]" value="{{ $image->alt }}">
                        <input class="form-control"  placeholder="Title" type="text" name="{{ $row->field }}_ext[{{ $loop->index }}][title]" value="{{ $image->title }}">
                    </div>
