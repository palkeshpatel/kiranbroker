<section id="our-testimonial" class="bglight padding_bottom">
    ...
    <div class="container">
        <div class="owl-carousel" id="testimonial-slider">
            @foreach ($testimonial as $testimonial_rw )
                <div class="item testi-box">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-md-12 text-center">
                            <div class="testimonial-round d-inline-block">

                                <img src="{{ ($testimonial_rw->image!='')?asset('storage/'.$testimonial_rw->image):'images/testimonial-1.jpg' }}" alt="">
                            </div>
                            <h4 class="defaultcolor font-light top15"><a href="#.">{{ $testimonial_rw->title }}</a></h4>
                            <p>{{ $testimonial_rw->position }}</p>
                        </div>
                        <div class="col-lg-6 offset-lg-2 col-md-10 offset-md-1 text-lg-left text-center">
                            <p class="bottom15 top90">{{ $testimonial_rw->description }}</p>
